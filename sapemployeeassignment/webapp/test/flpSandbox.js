		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee A",
									"targetURL": "#sapemployeeassignment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapemployeeassignment-display": {
								"semanticObject": "sapemployeeassignment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapemployeeassignment",
									"url": sap.ui.require.toUrl("sapemployeeassignment")
								}
							}
						}
					}
