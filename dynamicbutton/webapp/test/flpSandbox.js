		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bu",
									"targetURL": "#dynamicbutton-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dynamicbutton-display": {
								"semanticObject": "dynamicbutton",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dynamicbutton",
									"url": sap.ui.require.toUrl("dynamicbutton")
								}
							}
						}
					}
